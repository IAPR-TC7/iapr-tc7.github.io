...
**09:40 - 10:40** Keynote #1 - Daya Sagar (Indian Statistical Institute): "Mathematical Morphology in Retrieval, Analysis, Reasoning, Modelling and Visualization of Patterns of Relevance to Geosciences: An Illustrative Overview" \
**10:40 - 11:30** Paper Session #1 \
**11:30 - 12:00** Break \
**12:00 - 13:00** Keynote #2 - Biplab Banerjee (Indian Insititute of Technology Bombay): "Few-shot Open-set Learning in the Context of Hyper-spectral Image Classification - Some Perspectives" \
...
Each paper is allocated a 15-minute time slot, consisting of a 12-minute presentation (PowerPoint or similar) and a 3-minute Q&A session.

## Session #1 (10:40 - 11:30)
